# -*- coding: utf-8 -*-
"""
Created on Tue Nov 29 14:45:25 2022
...
class BallDraw(object):
    def __init__ (self, parent):
        self.ball = Ball.Ball(100, 100, 6, -3, 10, "blue")
    ...
    def animate(self):
        ...
        while 0 < self.ball.x + self.ball.r and \
              self.ball.x - self.ball.r < self.maxx and \
              0 < self.ball.y + self.ball.r and \
              self.ball.y - self.ball.r < self.maxy and \
              not self.isstopped:
            # Move the ball
            self.draw_ball()
